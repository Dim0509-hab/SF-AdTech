...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Skills\SF\public\storage' => 'string',
...
'database.connections.sqlite.transaction_mode','database.connections.sqlite.pragmas','database.connections.mysql.driver','database.connections.mysql.host','database.connections.mysql.port',
'database.connections.mysql.database','database.connections.mysql.username','database.connections.mysql.password','database.connections.mysql.charset','database.connections.mysql.collation',
'database.connections.mysql.prefix','database.connections.mysql.strict','database.connections.mariadb.driver','database.connections.mariadb.url','database.connections.mariadb.host',
...
'database.connections.testing.url','database.connections.testing.host','database.connections.testing.port','database.connections.testing.database','database.connections.testing.username',
'database.connections.testing.password','database.connections.testing.unix_socket','database.connections.testing.charset','database.connections.testing.collation','database.connections.testing.prefix',
'database.connections.testing.strict','database.connections.testing.engine','database.migrations.table','database.redis.client','database.redis.options.cluster',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Skills\\SF\\public\\storage',
...
'web','api',);
        registerArgumentsSet('routes', 'register','login','logout','redirect','dashboard','advertiser.index',
'advertiser.create','advertiser.offers.destroy','advertiser.stats','advertiser.store','advertiser.offers.activate',
'advertiser.offers.deactivate','webmaster.offers','webmaster.offers.subscribed','webmaster.offers.subscribe','webmaster.offers.unsubscribe',
'webmaster.offers.link','webmaster.stats','admin.dashboard','admin.users.destroy','admin.pending',
'admin.approve','admin.reject','admin.users','admin.users.toggle','admin.users.role',
'admin.offers','admin.stats','admin.revenue.index','admin.revenue.export','storage.local',);
        registerArgumentsSet('views', 
'admin.analytics','admin.dashboard','admin.layout','admin.offers','admin.pending',
'admin.revenue.index','admin.users','advertiser.create','advertiser.index','advertiser.stats',
'auth.login','auth.register','layouts.app','webmaster.index','webmaster.link',
'webmaster.stats','webmaster.subscribed','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Skills.SF.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_CONNECTION_TEST',
'DB_HOST_TEST','DB_PORT_TEST','DB_DATABASE_TEST','DB_USERNAME_TEST','DB_PASSWORD_TEST',
'BROADCAST_DRIVER','CACHE_DRIVER','FILESYSTEM_DISK','QUEUE_CONNECTION','SESSION_DRIVER',
'SESSION_LIFETIME','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','APP_LOCALE','APP_FALLBACK_LOCALE','APP_TIMEZONE',
'VITE_APP_NAME',);
