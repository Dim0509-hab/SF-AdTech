                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Роль</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Дата регистрации</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><div class="d-flex px-2 py-1"><span class="text-xs font-weight-bold">{{ $user->id }}</span></div></td>
                                        <td>
                                        ...
                                        <td><span class="badge bg-gradient-info">{{ ucfirst($user->role) }}</span></td>
                                        <td>
